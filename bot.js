...
client.on("guildMemberAdd", member => {
  ...
  return channel.send(` •●***WELCOME TO BLACK MARKET***●•  منور كلان زد نتمنا لك اسعد الوفات معن في الكلان  ${member} `) 
}).catch(console.error)
})
...
var channel =member.guild.channels.find('name', '𝗖𝗛𝗔𝗧')
if (!channel) return;
...
client.user.setGame(`System|Z,CLAN`,"http://twitch.tv/S-F")
